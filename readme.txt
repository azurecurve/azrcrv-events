...
Shortcode usage is **[events category="webinars" widtht=150 height=150 limit=5]**; all parameters are optional and will use the defaults set via the settings page.
