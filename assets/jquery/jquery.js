...
jQuery(document).ready(function() {
	...
	jQuery('.nav-tab-wrapper-azrcrv-e .nav-tab').on('click',function(event) {
		var item_to_show = '.azrcrv_e_tabs' + jQuery(this).data('item');
...
var file_frame;
	...
	$('#azrcrv-e-upload-image-1').on('click', function( event ){
	...
	$('#azrcrv-e-remove-image-1').on('click', function( event ){
...
var file_frame;
	...
	$('#azrcrv-e-upload-image-2').on('click', function( event ){
	...
	$('#azrcrv-e-remove-image-2').on('click', function( event ){
...
var file_frame;
	...
	$('#azrcrv-e-upload-image-3').on('click', function( event ){
	...
	$('#azrcrv-e-remove-image-3').on('click', function( event ){
...
var file_frame;
	...
	$('#azrcrv-e-upload-image-4').on('click', function( event ){
	...
	$('#azrcrv-e-remove-image-4').on('click', function( event ){
