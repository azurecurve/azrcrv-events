 ...
 * @since 1.0.0
 */
if ( ! function_exists( 'azrcrv_create_plugin_menu_e' ) ) {
	function azrcrv_create_plugin_menu_e() {
		azrcrv_populate_plugin_menu_e();
	}
}
 ...
 * @since 1.0.0
 */
if ( ! function_exists( 'azrcrv_populate_plugin_menu_e' ) ) {
	function azrcrv_populate_plugin_menu_e() {
