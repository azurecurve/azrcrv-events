...
<table class="form-table">
	...
	<tr>
		<th scope="row"><label for="shortcode-width"><?php esc_html_e( 'Width', 'azrcrv-e' ); ?></label></th>
		<td>
	...
	<tr>
		<th scope="row"><label for="shortcode-height"><?php esc_html_e( 'Height', 'azrcrv-e' ); ?></label></th>
		<td>
